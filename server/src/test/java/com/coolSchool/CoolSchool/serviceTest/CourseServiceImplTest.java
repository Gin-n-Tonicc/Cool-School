...
//        CourseResponseDTO result = courseService.createCourse(courseDTO, (PublicUserDTO) httpServletRequest.getAttribute(JwtAuthenticationFilter.userKey));
//        assertNotNull(result);
//    }
//
//    @Test
...
//        when(userRepository.findByIdAndDeletedFalse(any())).thenReturn(Optional.of(new User()));
//        when(categoryRepository.findByIdAndDeletedFalse(any())).thenReturn(Optional.of(new Category()));
//        CourseResponseDTO result = courseService.updateCourse(courseId, updatedCourseDTO);
//        assertNotNull(result);
//    }
//
//    @Test
